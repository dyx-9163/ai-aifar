...
- [src/agent/tools/toolRouter.ts:1-196](file://src/agent/tools/toolRouter.ts#L1-L196)
...
- 支持读取/搜索/补丁/命令等工具，受工作区信任级别与安全策略约束。
...
### 工具路由与安全策略
- 读工具（workspace_tree、read_file、search_code）可直接执行。
- 写工具（apply_patch、run_command）需要 read-write 信任；命令执行需白名单或用户审批。
- 所有失败归一化为结构化 AgentToolResult，便于上层统一处理。

章节来源
- [src/agent/tools/toolRouter.ts:1-196](file://src/agent/tools/toolRouter.ts#L1-L196)
- [src/shared/toolProtocol.ts:1-75](file://src/shared/toolProtocol.ts#L1-L75)
...
- [src/agent/modelProvider.ts:1-800](file://src/agent/modelProvider.ts#L1-L800)
- [src/agent/tools/toolRouter.ts:1-196](file://src/agent/tools/toolRouter.ts#L1-L196)
- [src/shared/domain.ts:1-331](file://src/shared/domain.ts#L1-L331)
